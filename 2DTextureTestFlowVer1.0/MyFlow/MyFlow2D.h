...
private:
	...
	LPDIRECT3DTEXTURE9  m_ppTmpScalarTexture[2];	// To Keep Old Target
...
public:
	...
	int GetNumOfScalars() {return g_NScalar;}
	int GetNumOfVectors() {return g_NVector;}

	// Interfaces for DXUT Framework
	void OnReset();
	void OnLost();
	void OnDestroy() {;}
