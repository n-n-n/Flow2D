...
static const int SCALAR_MAX_NUM = 2; // 9, 10	Ç≈Ç»ÇÒÇ©Ç÷ÇÒÅB
...
// Head Ç≈Ç»ÇØÇÍÇŒOK
static const int AlignedSize = 4; // 4 Packed Single-Precision FPÇópÇ¢ÇÈ
typedef __declspec(align(16)) float AFloat; // APSÇégÇ¢ÇΩÇ¢ÇÃÇ≈16BYTEÇ…alignÇ≥ÇπÇÈ
...
protected:
	...
	int		m_Nscalar;					//	égópÇ∑ÇÈï™ÇÃèÍÇÃêî
	...
	void SetBoundary(AFloat* pFull);// boundary èàóùÇ™à·Ç§ÅAã´äEèåèÇ…âûÇ∂ÇƒïœÇ¶ÇÈ
